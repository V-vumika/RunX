...
export function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center px-6 pt-28 text-center sm:pt-32">
        <Reveal>
          <Eyebrow>Now running in your browser</Eyebrow>
        </Reveal>

        <Reveal delay={0.08}>
          <h1 className="ak-skywash mt-10 font-display font-medium leading-[0.88] tracking-[-0.03em] text-[clamp(4.75rem,16vw,12rem)]">
            RunX
          </h1>
        </Reveal>

        <Reveal delay={0.16}>
          <p className="mx-auto mt-6 max-w-lg text-pretty text-lg leading-relaxed text-mist">
...
function CardFan() {
  return (
    <Reveal
      delay={0.32}
      className="relative mt-16 hidden h-[300px] w-full overflow-hidden lg:block [mask-image:linear-gradient(to_bottom,#000_74%,transparent)]"
    >
      <div className="relative mx-auto h-full w-[400px]">
        {/* Shadow pool the cluster sits in. */}
        <div className="absolute left-1/2 top-20 h-40 w-[640px] -translate-x-1/2 rounded-[50%] bg-[radial-gradient(ellipse_at_center,rgba(0,0,0,0.6),transparent_70%)] blur-2xl" />

        {/* Left card, tucked behind and receded. */}
        <div className="absolute left-1/2 top-8 w-[340px] -translate-x-[126%] scale-[0.95] opacity-55 blur-[1px]">
        ...
        {/* Right card, mirror. */}
        <div className="absolute left-1/2 top-8 w-[340px] translate-x-[26%] scale-[0.95] opacity-55 blur-[1px]">
        ...
        <div className="absolute left-1/2 top-0 z-10 w-[400px] -translate-x-1/2">
